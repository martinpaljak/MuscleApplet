...
label0:
    ...
    private void GenerateKeyPairRSA(byte buffer[])
    {
        ...
        RSAPublicKey pub_key = (RSAPublicKey)getKey(pub_key_nb, (byte)1, key_size);
        PrivateKey prv_key = (PrivateKey)getKey(prv_key_nb, (byte)(alg_id == 0 ? 2 : 3), key_size);
        ...
        Util.arrayCopy(buffer, (short)8, keyACLs, (short)(prv_key_nb * KEY_ACL_SIZE), (short)KEY_ACL_SIZE);
        Util.arrayCopy(buffer, (short)14, keyACLs, (short)(pub_key_nb * KEY_ACL_SIZE), (short)KEY_ACL_SIZE);
        switch(options)
        {
        case 0: // '\0'
